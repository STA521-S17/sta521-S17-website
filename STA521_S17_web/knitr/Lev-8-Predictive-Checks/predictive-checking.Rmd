...
& \\
p(Y \mid \mu, a) & = \int p(Y \mid \lambda) p(\lambda \mid \theta, \theta/\mu) d \lambda \\
...
95% CI: (`r round(100*(1 - ci["women_alone",-1]), 0)`)
...
95% CI: ( `r round(100*(1 - ci[2,-1]), 0)`)


## Energetic Student

* provide an interpretation of the coefficent for `log(bupacts + 1)`
